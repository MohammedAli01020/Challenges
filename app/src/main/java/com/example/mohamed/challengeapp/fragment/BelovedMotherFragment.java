...
public class BelovedMotherFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        title.setText(getString(R.string.chat_section_title_beloved_mother));
        image.setImageResource(R.drawable.ic_beloved_mother);

        image.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent fitnessIntent =new Intent(getContext(), SectionDetailsActivity.class);
                fitnessIntent.setAction("action-belovedMother");
